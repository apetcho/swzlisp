...
// -*-
static void _swz_simple_destroy(SWZRuntime *swz, void *arg){
    (void)swz;
    free(arg);
}
...
static void _swz_env_destroy(SWZRuntime *swz, void *arg);
...
static void _swz_txt_destroy(SWZRuntime *swz, void *arg);
