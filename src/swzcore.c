...
// _swz_builtin_macro(...)
static SWZObject* _swz_builtin_macro(SWZRuntime *swz, SWZEnv *env, SWZList *args, void *params){
    SWZ_UNUSED(params);
    SWZ_UNUSED(env);
    SWZList *argnames = NULL;
    SWZList *body = NULL;
    ...
    SWZ_FOREACH(self){
        if(self->car->type != swzSymbol){
            return swz_error(swz, SWZE_ERROR, "argument names must be symbols");
        }
    }
    lambda = (SWZLambda *)swz_alloc(swz, swzLambda);
    lambda->params = argnames;
...
// _swz_builtin_progn(...)
static SWZObject* _swz_builtin_progn(SWZRuntime *swz, SWZEnv *env, SWZList *args, void *params){
    SWZ_UNUSED(params);
    return swz_progn(swz, env, args);
}
...
// _swz_builtin_eq(...)
static SWZObject* _swz_builtin_eq(SWZRuntime *swz, SWZEnv *env, SWZList *args, void *params){
    SWZ_UNUSED(params);
    SWZ_UNUSED(env);
    SWZObject *lhs = NULL;
    SWZObject *rhs = NULL;
